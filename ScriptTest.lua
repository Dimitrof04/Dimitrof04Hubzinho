...
ListLayoutTopbar.FillDirection = Enum.FillDirection.Horizontal
...
TPLabel.Text = "Tp Prees anyone to tp"
...
local function UpdatePlayerList()
	...
	for _, player in pairs(Players:GetPlayers()) do
		if player ~= LocalPlayer then
			...
			btn.TextColor3 = Color3.fromRGB(2, 221, 255)
			btn.TextScaled = true
...
UserInputService.InputChanged:Connect(function(input)
	if dragging and input.UserInputType == Enum.UserInputType.MouseMovement and not IsMaxSize then
